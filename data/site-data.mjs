...
// Several images per service, rotated by city so neighbouring pages don't
...
export const PROFILE_NOTES = {
  ...
  "painting": {
    ...
    modern: "Newer homes usually need less repair and more colour strategy — the original builder palette is often the only thing dating the house from the street.",
